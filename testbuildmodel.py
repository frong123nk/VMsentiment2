...
#classification data
  ...
  #data_cls.save('C:/Users/iFrong/Desktop/flask/data_cls.pkl')
...
#load pretrained finetuned model
    ...
    learn.fit_one_cycle(1, slice(1e-3 / (2.6 ** 4), 1e-3), moms=(0.8, 0.7),
                            callbacks=[SaveModelCallback(learn, every='improvement', monitor='accuracy', name='C:/Users/iFrong/Desktop/model/model_ml')])
    print("All finish")
